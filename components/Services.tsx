            ...
            <div className="flex flex-col xl:flex-row justify-center items-center gap-8">
                ...
                <div className="relative w-full h-auto min-w-60 sm:w-112 sm:h-80 md:w-124 md:h-84 border-4 rounded-3xl border-orange">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center pt-4 sm:pt-8 gap-2 sm:gap-4">
                        ...
                        <a href="#reservation" className="text-lg px-4 py-2 bg-orange text-charcoal rounded-xl">Закажи термин</a>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                    <div className="relative h-auto w-56 sm:w-88 sm:h-84 border-4 rounded-3xl border-orange">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center pt-4 sm:pt-8 gap-2 sm:gap-4">
                            <p className="font-semibold sm:font-bold text-2xl sm:text-5xl text-center py-2 px-6 sm:px-2">Домашна посета</p>
                            <a href="tel:+389077805229" className="text-lg px-4 py-2 bg-orange text-charcoal rounded-xl">077 805 229</a>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-around text-left max-w-80 gap-4">
                        ...
                        <p className="text-charcoal text-xl">Доколку сте на работа или на одмор, ние сме тука да внимаваме на вашите миленици преку денот и да ги шетаме.</p>
                        <p className="text-charcoal text-xl">Јавете се на <a href="tel:+389077805229" className="font-bold">077 805 229</a></p>
                    </div>
                </div>
            </div>
        </div>
