...
const CarouselButton = ({ direction, ...restProps }: ButtonPropType) => {
    const isPrev = direction === 'prev'
    const buttonClass = `embla__button embla__button--${direction}`
...
export const PrevButton = (props: ComponentPropsWithRef<'button'>) => (
    <CarouselButton direction='prev' {...props} />
);

export const NextButton = (props: ComponentPropsWithRef<'button'>) => (
    <CarouselButton direction='next' {...props} />
);