        ...
        <footer className="w-full flex items-center justify-center pb-20 pt-12">
            <div className="flex flex-col relative border-2 items-center justify-center rounded-3xl border-orange w-5/6 max-w-screen-xl p-4">
                ...
                <div className="flex flex-col items-center">
                    <a className="text-lg md:text-xl lg:text-2xl text-black mb-6 z-10" href="tel:+38977805229">077 805 229</a>
                </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <Image src={pawsFootprint} alt="Paws Footprint 3" className="absolute -bottom-4 -translate-x-3/4 rotate-[-154deg] w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14" />
                    <Image src={pawsFootprint} alt="Paws Footprint 4" className="absolute -top-2 right-1/4 translate-x-8 rotate-[163deg] w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14" />
                    <Image src={pawsFootprint} alt="Paws Footprint 5" className="absolute bottom-4 right-1/4 translate-x-16 lg:translate-x-32 rotate-[-177deg] w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14" />
                </div>

                <div className="flex flex-col justify-center gap-y-8 w-11/12 md:w-4/6 md:flex-row md:gap-0 py-2">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 md:justify-evenly md:pl-2 md:w-2/6">
