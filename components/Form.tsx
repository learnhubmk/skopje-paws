...
const FormComponent = () => {
    ...
    return (
        <form id={"contact"} className="bg-orange rounded-3xl p-5 flex flex-col shadow-xl w-full h-full" onSubmit={handleSubmit}>
            <h2 className="lg:text-3xl md:text-2xl font-extrabold mb-4 ">Контактирајте нѐ!</h2>
            <div className="flex flex-col lg:flex-row justify-between mb-6">
                <input
                    type="text"
                    className="rounded-xl mb-3 lg:mb-0 lg:mr-3 p-5 w-full lg:w-1/3 border-black border bg-orange placeholder-black  focus:outline-none"
                ...
                <input
                    type="text"
                    className="rounded-xl p-5 w-full lg:w-1/3 border-black border bg-orange placeholder-black  focus:outline-none"
        ...
        <textarea
            className="rounded-xl p-5 w-full lg:w-2/3  md:w-full h-60 bg-orange border-black border placeholder-black  focus:outline-none mb-3 lg:mb-0"
            placeholder="Вашата порака"
            required
        />
                <div
                    className="p-3 md:w-full lg:w-1/3 h-full flex flex-col md:flex-row justify-center items-center">
