...
const montserratFaq = Montserrat({ subsets: ['cyrillic'], weight: ['400', '500', '700'] });
  ...
  return (
    <div className="space-y-4 mx-auto flex size-full">
      <div className={`border-2 border-orange p-5 flex justify-between ${isActive ? 'rounded-3xl bg-orange flex-col' : 'rounded-full size-full'}`} >
        <h2 className={`font-medium text-xl size-full flex items-center justify-between ${isActive ? 'text-black' : 'text-orange'} ${montserratFaq}`}>
          {question}
