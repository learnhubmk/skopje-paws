            ...
            <div className="grid lg:grid-cols-2 gap-10 w-full sm:w-4/5 sm:grid-cols-1 text-charcoal">
                <div className="flex flex-col items-start gap-5">
                    <h2 className="text-2xl lg:text-4xl font-bold font-montserrat">Често поставувани
                        прашања</h2>
                    <p className="font-medium sm:text-xl font-montserrat">Погледнете дали вашето прашање се наоѓа во
                        овие прашања и договори. Доколку не се наоѓа, слобдно контактирајте не преку копчето подолу.</p>
                    <a href="/#contact"
                       className="font-montserrat text-black bg-orange font-medium rounded-lg text-base px-5 py-2.5 focus:outline-none">Поставете
                        Прашање</a>
                </div>
